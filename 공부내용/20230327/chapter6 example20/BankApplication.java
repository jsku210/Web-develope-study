...
public class BankApplication {
	private static Account aabc = null;
...
//		findAccount(a).setBalance(findAccount(a).getBalance() - b);
		accountArray[dd].setBalance(accountArray[dd].getBalance() - b);
	}
	...
	private static void deposit() { // 예금하기
		...
		int b = scanner.nextInt();
//		aabc.setBalance(findAccount(a).getBalance() + b);
		accountArray[dd].setBalance(accountArray[dd].getBalance() + b);
	}
...
//				String b = accountArray[i].getOwner();
//				int c = accountArray[i].getBalance();
//				aabc = new Account(a, b ,c);
					break;
				} else {
					continue;
				}
